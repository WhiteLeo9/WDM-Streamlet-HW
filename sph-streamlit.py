...
for element in selected_elements:
    ...
    ax2.plot(T_vs_D_sorted[:, 0], T_vs_D_sorted[:, 1], linestyle=style_map[element], marker=marker_map[element], linewidth=0.5, markersize=2)
...
legend1 = ax.legend(handles=color_legend_elements, title="Temperature", loc='upper left', fontsize=5, title_fontsize=6)
...
ax.tick_params(which='minor', top=True, right=True, length=1, direction='out', labelsize=8, width=0.5)
ax.tick_params(which='major', length=2, top=True, right=True, direction='out', labelsize=8, width=0.8)
