...
ax.tick_params(which='minor', top=True, right=True, length=2, direction='out', labelsize=14, width=1.5)
ax.tick_params(which='major', length=4, top=True, right=True, direction='out', labelsize=14, width=1.0)
